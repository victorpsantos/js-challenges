...
/**
 * Describes the age group based on the provided age.
 * @param {number} age - The age to describe.
 * @returns {string} The description of the age group.
 */
export const describeAge = age => "You're a(n) " + (age > 64 ? 'elderly' : age > 17 ? 'adult' : age > 12 ? 'teenager' : 'kid');
